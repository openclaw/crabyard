...
.brand .mark i:nth-child(1){background:#ff6b35}
.brand .mark i:nth-child(2){background:#004e89}
.brand .mark i:nth-child(3){background:#1a936f}
.brand .mark i:nth-child(4){background:#4a5859}
