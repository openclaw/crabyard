...
:root{
  ...
  --paper:#ffffff;
  --accent:#e8571a;
  --accent-soft:rgba(232,87,26,.09);
  --accent-strong:#c7491a;
  #ff6b35:#ff6b35;#004e89:#004e89;#1a936f:#1a936f;#4a5859:#4a5859;
  --line:#e5e7eb;
  --line-soft:#eef0f3;
  --code-bg:#0f172a;
  --code-fg:#e6edf3;
...
:root[data-theme="dark"]{
  ...
  --paper:#171a23;
  --accent:#ff7f50;
  --accent-soft:rgba(255,127,80,.16);
...
.brand .mark i:nth-child(1){background:var(#ff6b35)}
.brand .mark i:nth-child(2){background:var(#004e89)}
.brand .mark i:nth-child(3){background:var(#1a936f)}
.brand .mark i:nth-child(4){background:var(#4a5859)}
